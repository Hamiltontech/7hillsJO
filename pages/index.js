      ...
      <div className="font-blinker">
        ...
        {newsletter && (
          <div
            ...
            tabindex="-1"
            aria-hidden="true"
            class=" shadow-xl shadow-blackk fixed pt-[120px] justify-center z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[800px] grid place-items-center"
          >
